...
(function() {
  ...
  window.AppViewModel = (function() {
    ...
    function AppViewModel() {
      var _this = this;
      window.app = this;
      _.bindAll(this, 'deleteAllThings', 'saveAllThings');
      this.collections = {
      ...
      if (!this.router) {
        ...
        this.router.route('things', null, function() {
          return _this.loadPage(kb.renderTemplate('things_page', new ThingsPageViewModel()));
        });
        this.router.route('things/:id', null, function(id) {
          var model;
    ...
    AppViewModel.prototype.deleteAllThings = function() {
    ...
    AppViewModel.prototype.saveAllThings = function() {
      var model, _i, _len, _ref;
